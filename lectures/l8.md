---
layout: module
title: "8 - Code-Level Design Principles"
permalink: /modules/8-code-level-design
parent: Modules
nav_order: 8
lessons: 
  - title: Writing Maintainable Code
    pdf: "Module 08 Code Level Design.pdf"
    ppt: "Module 08 Code Level Design.pptx"
...
### Important Dates:
* Individual Project2 **Due Wednesday, February 4 by 11am (EST)**{: .label .label-red }

{% include lesson.html %}

### Activity
* Traffic Light [Activity]({{site.baseurl}}{% link Activities/Module08 Activity.md %})
