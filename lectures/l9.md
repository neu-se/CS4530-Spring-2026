---
layout: module
title: "9 - Concurrency Patterns in Typescript"
permalink: /modules/9-concurrency-patterns-in-typescript
parent: Modules
nav_order: 9
lessons: 
  - title: "Concurrency Patterns in Typescript"
    ppt: "Module 09 Concurrency Patterns in Typescript.pptx"
    pdf: "Module 09 Concurrency Patterns in Typescript.pdf"
...
### Important Dates:
* Preliminary Project Plan **Due February 11, 2026 by 11am (EST)**{: .label .label-red } 

{% include lesson.html %}

### Activities:
* [Async Activity]({{ site.baseurl }}{% link Activities/Module09 Activity.md %}) 

### Resources
* [Code Examples from Slides]({{ site.baseurl }}{% link Examples/module-09-async-examples.zip %})
