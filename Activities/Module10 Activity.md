...
### Grading Rubric:
This assignment is worth 10 points. Any suitable attempt at testing the `socketLeave` controller will get partial credit, and any test that passes on our implementation and assesses the behavior of `socketLeave` suitably will get full credit.