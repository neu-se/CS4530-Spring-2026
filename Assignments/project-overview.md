...
| 04/10/2026 | [Project Delivery]({{ site.baseurl }}{% link Assignments/project-deliverable.md %}) - Implementation and Documentation | Deliver/[Deploy]({{ site.baseurl }}{% link Activities/Module12 Activity.md %}) your new features, including design documentation and tests |
...
* Process (20%)
  ...
  * This also includes appropriate division of labor within the project (i.e., roughly equal). For full credit, each member of the team must have at least 2 commits during the each sprint (i.e., sprints 1,2 & 3) even when using pair programming.
* Product (40%)
